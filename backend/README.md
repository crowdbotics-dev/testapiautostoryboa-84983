...
## Project Structure
    ...
    ├── testapiautostoryboa_84983  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_84983`
...
2. Clone this repo and `cd testapiautostoryboa_84983`
